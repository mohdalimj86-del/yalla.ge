  ...
  return (
    <div>
      <div className="text-center mb-12">
        <h1 className="text-4xl font-bold text-gray-900 dark:text-white">{t('accommodation.title')}</h1>
        <p className="mt-2 text-lg text-gray-600 dark:text-gray-400">{t('accommodation.subtitle')}</p>
      </div>
      <div className="mb-8 flex flex-col md:flex-row items-center justify-center gap-4">
         ...
         {isAuthenticated && (
            ...
            >
              ...
              {t('nav.add_accommodation')}
            </Link>
         )}
      </div>
      <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-8">
        {accommodationListings.map((listing: Listing) => (
