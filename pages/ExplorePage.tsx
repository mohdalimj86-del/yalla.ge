    ...
    <div>
      <div className="text-center mb-12">
       ...
       <div className="mb-8 flex flex-col md:flex-row items-center justify-center gap-4">
        ...
        <button 
            type="button"
            className="px-6 py-3 bg-green-500 text-white font-semibold rounded-full transition-colors disabled:bg-green-300 disabled:cursor-not-allowed dark:disabled:bg-green-700"
            disabled
